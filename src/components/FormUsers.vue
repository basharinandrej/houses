...
export default {
    ...
    methods: {
        ...
        saveDataLocalStore() {
            localStorage.setItem('nameAdmin', JSON.stringify(this.name))
            localStorage.setItem('avatarAdmin', JSON.stringify(this.avatar))
            localStorage.setItem('isAuth', JSON.stringify(true))
        },
        updateDataAdmin() {
          this.$store.commit('saveDataAdmin')
        },
        submitHandler() {
          this.saveDataLocalStore()
