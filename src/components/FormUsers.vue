  ...
  <form @submit.prevent="submitHandler">
    <div class="mb-3">
      ...
      <input type="text"
             ...
             :value="name"
             @change="enterNameHandler"

      >
    </div>
    <div class="mb-3">
      <label for="exampleInputPassword1" class="form-label">Ссылка на аватра</label>
      <input type="text"
             class="form-control"
...
export default {
  ...
  methods: {
      enterNameHandler(e) {
        localStorage.setItem('nameAdmin', JSON.stringify(e.target.value))
      }
  }
}
</script>
